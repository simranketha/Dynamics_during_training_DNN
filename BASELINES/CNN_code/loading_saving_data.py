...
def results_fol_name(results_folder,corrupt):
    ...
    results_corr=f'{results_folder}/results_{corrupt}'
    os.makedirs(results_corr,exist_ok=True)
    return results_corr
...
def layer_name(type_network):
    if type_network =='ResNet18':
        data_layer = ['after_layer_0','after_layer_0_1','after_layer_0_2','after_layer_0_3',
                      'after_layer_1','after_layer_2','after_layer_3','after_layer_4','before_fc']
    
        pca_layer = ['l0','l0_1','l0_2','l0_3','l1','l2','l3','l4','bf_last']#
        num_class=10
...
def data_loading_train(temp_path, d_layer):
    ...
    return layer_output, cor_targets