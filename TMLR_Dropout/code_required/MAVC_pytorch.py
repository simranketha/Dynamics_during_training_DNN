...
#     'input',
        num_class=10
    return data_output_name,data_layer_name,num_class
...
def MAVC_fn_neg_pca_drop(type_network,temp_path,run,results,n,epoch_present,subspace_type):
...
#     print(type_network)
    ...
    with torch.no_grad(): 
        for p_layer,d_layer in zip(pca_layer,data_layer):
            ...
            layer_output,_=data_loading_train(temp_path, d_layer)
