...
def temp_store(ds,type_network,corrupt,run,n_value,seed_value,epoch,layer_number):
    ...
    temp_path = f'Network_data/dropout_{ds}_{type_network}_{corrupt}_{run}_{seed_value}_{epoch}_{layer_number}_{n_value}'
    os.makedirs(temp_path,exist_ok=True)
      
    results_folder=f'results/{seed_value}/angle_results_{n_value}/{ds}_{type_network}_dropout'
...
#     n_value=1
    ...
    for model_epoch in model_numbers:  
        ...
        temp_path,results_corr=temp_store(ds,type_network,
                                      corrupt,run,n_value,seed_value,epoch,layer_number=layer_number)
        print(temp_path,results_corr)
